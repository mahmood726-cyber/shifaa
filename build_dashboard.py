...
<div class="finding"><h3>Finding</h3>72 of 180 countries have zero registered clinical trials despite collectively bearing 28% of global DALYs. The USA alone concentrates 1,281 weighted trial-equivalents &mdash; more than the bottom 120 countries combined.</div>
...
<div class="finding"><h3>Finding</h3>Disease burden has a <span style="color:#ff4444;font-weight:bold">negative</span> effect on trial activity (beta = -0.255, p &lt; 0.001). Countries with more disease get <em>fewer</em> trials. GDP per capita is the strongest positive predictor (beta = +0.469, p = 0.004). <strong>Money, not need, determines where healing knowledge is generated.</strong></div>
<h3 style="color:#aaa;margin:1rem 0 0.5rem">Poisson Regression Coefficients (158 countries)</h3>
...
<div class="finding"><h3>Finding</h3>Under baseline assumptions (2% annual DALY growth in low-income countries, 1% trial growth), the 37 countries with over 1 million DALYs and zero trials face a <strong>30% widening</strong> of the mercy gap by 2036.</div>
<div class="stats">
...
<div class="finding"><h3>Finding</h3>If governance quality in the 30 largest evidence deserts reached the median of lower-middle-income nations and health expenditure rose to 5% of GDP, the model predicts a <strong>3.2-fold increase</strong> in trial activity, potentially bringing 22 of 30 countries above the zero-trial threshold.</div>
<div class="stats">
...
<div class="finding"><h3>The Binding Constraint</h3>GDP per capita remains the binding constraint for the poorest nations. Even optimal governance is insufficient without direct research investment. The most responsive countries are those with existing but underfunded health infrastructure: Angola, Mozambique, and DR Congo.</div>
</div>

<div class="panel" id="p4">
<h2 style="color:#e8c547;margin-bottom:1rem">The Reckoning (Hisab)</h2>
<div class="finding"><h3>Finding</h3>The Gini coefficient of trial distribution was <strong>0.915 in 2005</strong> and <strong>0.893 in 2023</strong> &mdash; extreme inequality comparable to the world's most unequal wealth distributions, showing negligible improvement over nearly two decades. COVID-19 produced no equity dividend.</div>
